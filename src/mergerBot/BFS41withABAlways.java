 ...
 *
 */
public class BFS41withABAlways implements Bot {
    private static final Direction[] DIRECTIONS = new Direction[]{Direction.UP, Direction.DOWN, Direction.LEFT, Direction.RIGHT};
    // for alpha-beta
    alphabeta alphaBetaBot = new alphabeta();
...
//            if (distanceBetween(head, apple) > distanceBetween() && !circle_complete) {
//
//            }
            ...
            move = alphaBetaBot.chooseDirection(snake, opponent, mazeSize, apple, startTime);
