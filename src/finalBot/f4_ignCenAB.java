 ...
 */
public class f4_ignCenAB implements Bot, Runnable {
    ...
    private int scr_weReachedCentre = 0;  // IGNORING CENTER

    private int fct_distanceToApple = -5;
    private int fct_distanceToCentre = 0;  // IGNORING CENTER
    ...
    private Direction chooseMove(Snake snake, Snake opponent, Coordinate mazeSize, Coordinate apple) {
        ...
        if (circle_type > 0 && snake.body.size()>5) {  // here we are circling
            if (!circle_complete) {
                ...
                // this checks if the circle is complete
            }
