...
/**
 * copy from fLogicPercAB -> switched to checking reachable tiles with BFS instead of simple distance
 */
public class fLogicPathsAB implements Bot, Runnable {
...
//            System.out.println("enemy snake lost a lot of movement space");
    ...
    public void run() {
        ...
        System.out.println("Depth level reached (longBFS-Paths): " + (i - 2) / 2);
    }
        ...
        if (maximizingPlayer) { // Our snake
            ...
            for (Direction move : moves) { // The rest works the same as above unless there is a comment
                ...
                if ((int) updatedState[3] == (depth + 1) / 2 || (int) updatedState[2] == (depth + 1) / 2) { // If someone ate an apple at this depth layer
                    ...
                    // now using the long-time-taking-BFS-version:
                    updatedState[5] = percentageOfTilesCloserToUs((Snake) updatedState[0], (Snake) updatedState[1], mazeSize, apple);
                }
