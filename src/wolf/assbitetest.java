 ...
 */
public class assbitetest implements Bot {
    ...
    public Direction chooseDirection(Snake snake, Snake opponent, Coordinate mazeSize, Coordinate apple) {
        ...
        if(turn_wolf==1){turn_wolf++; return Direction.RIGHT;}
        if(turn_wolf==2){turn_wolf++; return Direction.DOWN;}

        if(turn_wolf==3){ turn_wolf=0; return Direction.LEFT;}
