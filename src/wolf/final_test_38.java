...
/**
 * copy from f6 -> added logic
 */
public class final_test_38 implements Bot, Runnable {
    ...
    public boolean startshit = false;
    public boolean found_position_5=false;



    public boolean ihavetofewhoursofsleepinaday=false;
    ...
    public Direction chooseDirection(Snake snake, Snake opponent, Coordinate mazeSize, Coordinate apple) {
        ...
        this.apple = apple;
        /*
        System.out.println("Close tiles: ");
        System.out.println("real: " + percentageOfTilesCloserToUs(snake, opponent, mazeSize, apple));
        System.out.println("estimate: " + simplePercentageOfTilesCloserToUs(snake, opponent, mazeSize, apple));
        System.out.println("estimate dos: " + simplePercentageOfTilesCloserToUsDos(snake, opponent, mazeSize, apple));
        System.out.println();
        */
    ...
    private Direction chooseMove(Snake snake, Snake opponent, Coordinate mazeSize, Coordinate apple) {
        ...
        if(snake.body.size()>21){
            circle_type=39;
            if(!startshit) {
                circle_positions_length=5;
                circle_positions[0]=new Coordinate(0,6);
                circle_positions[1]=new Coordinate(0,0);
                circle_positions[2]=new Coordinate(4,0);
                circle_positions[3]=new Coordinate(4,2);
                circle_positions[4]=new Coordinate(10,10);
                apple=circle_positions[circle_positions_iterator];
                if (head.equals(circle_positions[3])&&circle_positions_iterator==3) {
                    startshit = true;
                }
            }
            if(startshit) {
                apple = new Coordinate(6, 0);
                if (!ihavetofewhoursofsleepinaday) {
                    setCircle_positions(apple, circle_type, mazeSize);
                    System.out.println("Start gek gedoe");
                    ihavetofewhoursofsleepinaday = true;
                }
            }
        }
...
//                System.out.println("circling move with BFS41");
                ...
                System.out.println("circle_completos");
